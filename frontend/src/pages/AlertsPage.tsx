...
export const AlertsPage = () => {
  ...
  const getSeverityColor = (severity: AlertSeverity) => {
    switch (severity) {
      ...
      case AlertSeverity.LOW:
        return { bg: 'var(--color-bg-tertiary)', color: 'var(--color-brand)', icon: 'ℹ', label: 'Low' };
    }
  };
  ...
  return (
    <div style={{
      ...
      {/* Fixed Header Section - Title, Filters, and Bulk Actions */}
      <div style={{
        flexShrink: 0,
        marginBottom: '20px',
        ...
        {selectedAlertIds.size > 0 && (
          <Card style={{ backgroundColor: 'var(--color-bg-tertiary)' }}>
      ...
      {/* Scrollable Content Section - Alerts List */}
      <div>
        <Card>
          {isLoading ? (
