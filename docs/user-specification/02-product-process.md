...
**시리얼 번호 형식:** `PSA10-KR-251110D-001-0001`
...
| LOT 번호 | 설명 |
|----------|------|
| `PSA10-KR-251110D-001` | PSA10 모델, 2025년 11월 10일 주간조 첫 번째 LOT |
| `PSA10-KR-251110D-002` | PSA10 모델, 2025년 11월 10일 주간조 두 번째 LOT |
| `PSA10-KR-251110N-001` | PSA10 모델, 2025년 11월 10일 야간조 첫 번째 LOT |
| `PSA10-KR-251111D-001` | PSA10 모델, 2025년 11월 11일 주간조 첫 번째 LOT (날짜 변경으로 순번 초기화) |

**확장성:**

- 향후 다른 모델 추가 시: `AG01-KR-251110D-001` (AG01 = Agriculture 농업용 모델)
- 향후 해외 생산지 추가 시: `PSA10-US-251110D-001` (US = 미국)
...
| 구분 | 길이 | 설명 | 예시 | 비고 |
|------|------|------|------|------|
| LOT 번호 | 가변 | 상위 LOT 번호 | PSA10-KR-251110D-001 | 2.6.1 LOT 번호 체계 참조 |
| 제품 순번 | 4자리 | LOT 내 제품 순서 | 0001 | 0001~9999 (일반적으로 0001~0100) |

**전체 길이:** 가변 (LOT 번호 길이 + 5자리, 하이픈 구분자 포함)
...
| 시리얼 번호 | 설명 |
|-------------|------|
| `PSA10-KR-251110D-001-0001` | 해당 LOT의 첫 번째 제품 |
| `PSA10-KR-251110D-001-0050` | 해당 LOT의 50번째 제품 |
| `PSA10-KR-251110D-001-0100` | 해당 LOT의 100번째 (마지막) 제품 |
