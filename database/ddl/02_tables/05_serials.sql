...
-- Purpose: Auto-generate serial number in format: LOT_NUMBER-XXXX
...
BEGIN
    ...
    IF v_sequence > 100 THEN
        RAISE EXCEPTION 'LOT capacity exceeded: maximum 100 serials allowed';
    END IF;
...
COMMENT ON COLUMN serials.serial_number IS 'Auto-generated serial identifier in format: LOT_NUMBER-XXXX';
...
-- 4. Serial numbers are auto-generated in format: {LOT_NUMBER}-XXXX
