...
-- =============================================================================
/*
INSERT INTO equipment (equipment_code, equipment_name, equipment_type, description, manufacturer, model_number, process_id, production_line_id, status) VALUES
-- Laser Marking Equipment
('EQ_LASER_001', '레이저 마킹기 001', 'LASER_MARKER', 'High precision fiber laser marker', 'Keyence', 'MD-X2500', 1, 1, 'AVAILABLE'),
('EQ_LASER_002', '레이저 마킹기 002', 'LASER_MARKER', 'High precision fiber laser marker', 'Keyence', 'MD-X2500', 1, 2, 'AVAILABLE'),

-- Assembly Equipment
('EQ_ASSEM_001', '조립 장비 001', 'ASSEMBLY_STATION', 'LMA assembly workstation', 'Custom', 'AS-100', 2, 1, 'AVAILABLE'),
('EQ_ASSEM_002', '조립 장비 002', 'ASSEMBLY_STATION', 'LMA assembly workstation', 'Custom', 'AS-100', 2, 2, 'AVAILABLE'),

-- Inspection Equipment
('EQ_INSP_001', '검사 장비 001', 'INSPECTION_STATION', 'Sensor inspection equipment', 'National Instruments', 'PXI-4461', 3, 1, 'AVAILABLE');
*/
